...
A collection of nine example repositories demonstrating different IaC tools, runtime architectures, and application patterns -- all integrated with the [ironskillet](https://github.com/fullmetalskillet/ironskillet-infra) compliance system.
...
| ---- | --- | ------- | ----------- |
| [spin-min](https://github.com/fullmetalskillet/spin-min) | Terraform | EC2 + Flask + wasmtime | Mandelbrot fractal explorer (Wasm compute) |
| [spin-full](https://github.com/fullmetalskillet/spin-full) | Terraform | EC2 + Flask + wasmtime | Wasm benchmark lab (4 kernels) |
| [juno](https://github.com/fullmetalskillet/juno) | Terraform | EC2 + Flask + SQLite + wasmtime | Notebook with Wasm text processing |
| [magic-8ball](https://github.com/fullmetalskillet/magic-8ball) | Terraform | API Gateway + Lambda | Magic 8-Ball oracle API |
| [dad-jokes](https://github.com/fullmetalskillet/dad-jokes) | CloudFormation | API Gateway + Lambda | Daily dad joke service |
| [color-palette](https://github.com/fullmetalskillet/color-palette) | Pulumi | API Gateway + Lambda | Random color palette generator |
| [mesh-dash](https://github.com/fullmetalskillet/mesh-dash) | Terraform + Ansible | EC2 + Node.js + React + PgSQL | Network mesh monitoring dashboard |
| [field-report](https://github.com/fullmetalskillet/field-report) | Terraform + Ansible | EC2 + FastAPI + PgSQL | Field incident reporting API |
| [asset-ledger](https://github.com/fullmetalskillet/asset-ledger) | Terraform + Ansible | EC2 + .NET 8 + Vue.js + PgSQL | Asset tracking with audit log |
...
All nine repos follow a standardized credential management and deployment strategy that mirrors the [ironskillet-infra](https://github.com/fullmetalskillet/ironskillet-infra) conventions. Every repo can be deployed with two commands:
...
1. **Tagging** -- 5 required tags on all resources (Project, Environment, ManagedBy, Repository, Lifecycle) via the [compliance-tags](https://github.com/fullmetalskillet/ironskillet-infra/tree/main/modules/aws/compliance-tags) module
2. **Registration** -- SSM parameter at `/{project}/{environment}/iac-registry/{repo-slug}` via the [iac-registry](https://github.com/fullmetalskillet/ironskillet-infra/tree/main/modules/aws/iac-registry) module
...
See the [Multi-Repo Compliance Guide](https://github.com/fullmetalskillet/ironskillet-infra/blob/main/docs/guides/MULTI-REPO-COMPLIANCE.md) for detailed onboarding instructions.
